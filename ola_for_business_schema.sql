-- ============================================================================
-- Ola for Business -- Supabase (Postgres) schema  v1.0  [GENERATED]
...
--
-- 4 entities: account, contact, opportunity, case. Canonical UUID ids.
-- Conventions: snake_case; id uuid PK default gen_random_uuid();
-- created_at/updated_at timestamptz not null; FK columns <parent>_id;
-- created_by/last_changed_by AUDIT ONLY (no FK). Parent-before-child order.
-- ============================================================================
